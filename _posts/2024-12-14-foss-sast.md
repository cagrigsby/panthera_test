...
Test that it worked with:`sudo docker run hello-world`. You should get a message from the output that says: "This message shows that your installation appears to be working properly." At this point docker is installed. 
